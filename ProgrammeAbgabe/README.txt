...
The first file for chronological usage would be CleanMetadataDeleteBidetAddNegativeClass.py. It cleans the metadata and is the newest of the three CleanMetadata-programs, thus removing bidet and adding negative class.
