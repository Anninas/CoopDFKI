# -*- coding: utf-8 -*-
"""
Created on Thu Sep 17 18:14:51 2020
...
new_path = os.path.join(os.path.dirname(__file__), "../Formal/f1_scores_automated_training_13_IRV2_binary.json")
new_path2 = os.path.join(os.path.dirname(__file__), "../Formal/f1_scores_automated_training_13_IRV2binary_testresults.json")
...
#Save net
net_path = os.path.join(script_dir, "../Netze/try13_IRV2_binary.h5")
